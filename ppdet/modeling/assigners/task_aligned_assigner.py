...
class TaskAlignedAssigner(nn.Layer):
    ...
    def forward(self,
        ...
        if num_max_boxes == 0:
            ...
            assigned_iou = paddle.zeros(
                [batch_size, num_anchors, num_classes])
            return assigned_labels, assigned_bboxes, assigned_scores, assigned_iou
        ...
        assigned_ious = ious * mask_positive
        assigned_ious = assigned_scores * assigned_ious.sum(-2).unsqueeze(-1)
