...
def main():
    ...
    parser.add_argument(
        '--image_dir', type=str, default='/mnt/DataSets/齿轮检测数据集/trainval/JPEGImages', help="The image folder path.")
    parser.add_argument(
        '--json_path', type=str, default='/mnt/DataSets/齿轮检测数据集/trainval/train.json', help="Dataset json path.")
    parser.add_argument(
        '--output_dir', type=str, default='/mnt/DataSets/齿轮检测数据集/trainval_sliced', help="Output dir.")
    parser.add_argument(
        '--slice_size', type=int, default=800, help="slice_size")
    parser.add_argument(
